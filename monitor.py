...
import time, requests, smtplib, math
...
server.ehlo()
server.starttls()
gmail_user = 'covidvaccinespotterscraper@gmail.com'
gmail_password = 'wzmiwytqdrvdobrc'
    ...
    for user in active_users:
        ...
        for appointment in states_dict[ user["state"] ]["features"]:
            ...
            try:
                ...
                if ((dist <= user["distance"]) and (appointment["properties"]["appointments_available"])):
        ...
        send_email(user["email"], accepted_appointments)


def send_email(recipient, appointments):
    mail_content = "Appointments found at: \n"
